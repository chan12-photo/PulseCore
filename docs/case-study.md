...
- macOS local presets: dev, release, ASan/UBSan, TSan, and profile all pass 69/69 tests
- Ubuntu 24.04 Docker release run passes 90/90 tests, including Linux-only epoll and CLI smoke tests
