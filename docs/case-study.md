...
- macOS local presets: dev, release, ASan/UBSan, TSan, and profile all pass 66/66 tests
- Ubuntu 24.04 Docker release run passes 86/86 tests, including Linux-only epoll and CLI smoke tests
