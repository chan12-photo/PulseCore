...
- macOS local presets: dev, release, ASan/UBSan, TSan, and profile all pass 71/71 tests
- Ubuntu 24.04 Docker release run passes 95/95 tests, including Linux-only epoll and CLI smoke tests
