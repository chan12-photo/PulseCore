...
The connection registry owns live non-blocking connections for the epoll reactor.
...
The registry is owned by the reactor thread. Worker threads must not mutate it directly.
